import { SELECT_F_PROJECTION, REQUEST_F_PROJECTION, RECEIVE_F_PROJECTION, HIGHLIGHT_SAMPLE, UNHIGHLIGHT_SAMPLE,
  SELECT_SAMPLE, UNSELECT_SAMPLE, UPDATE_SELECTIONS } from 'redux/actions/types'

export const fprojection = (
  state = {
    isFetching: false,
    data: [],
    vars: [],
  ...
  switch (action.type) {
    case SELECT_F_PROJECTION:
      return Object.assign({}, state, {
        name: action.name
      })
    case REQUEST_F_PROJECTION:
      return Object.assign({}, state, {
        isFetching: true
      })
    case RECEIVE_F_PROJECTION:
      return Object.assign({}, state, {
        isFetching: false,
        data: action.data,
        vars: action.vars,
